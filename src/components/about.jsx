    ...
    return (
        ...
        >
            <div className="rounded-lg relative ">
                ...
                <div className="text-zinc-300 font-inconsolata text-lg max-mobile:text-sm  absolute top-28 left-8 right-6 max-mobile:text-white max-mobile:leading-[0.9rem] ">
