    ...
    return (
        ...
        >
            <div className="rounded-lg relative ">
                ...
                <div className="text-zinc-500 font-inconsolata text-xl max-mobile:text-sm absolute top-28 left-8 right-6 max-mobile:text-white overflow-hidden s-mobile:text-xs">
